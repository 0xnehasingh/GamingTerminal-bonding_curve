...
describe("Launchpad", () => {
  ...
  it("should create a target config and new pool", async () => {
    ...
    try {
      ...
      console.log("✅ Target config created successfully!");
    } catch (error) {
    ...
    try {
      ...
      console.log("✅ Mint authority transferred to pool signer");
    } catch (error) {
  ...
  it("Should Swap Sol for Meme", async () => {
    ...
    console.log("User WSOL token account:", userSolTokenAccount.toBase58());
    // Get WSOL balance
    ...
    // 1. **Basic swap functionality tests**
    console.log("\n📊 Checking basic swap functionality...");
    ...
    console.log(`User WSOL before: ${userWsolBalance.amount.toString()}`);
    console.log(
      `  User WSOL after: ${updatedUserWsolBalance.amount.toString()}`
    );
    console.log(`User MEME before: 0`);
    console.log(
      `  User MEME after: ${updatedUserMemeBalance.amount.toString()}`
    );
  ...
  it("Should Raydium Migrate", async () => {
    ...
    console.log("Test9");
    try {
      console.log("🚀 Attempting Raydium migration...");
      console.log("Pool:", poolPda.toBase58());
      console.log("Meme Mint:", memeMint.toBase58());
      console.log("Quote Mint:", NATIVE_MINT.toBase58());
      console.log("AMM Config:", ammConfig.toBase58());
      console.log("Raydium Authority:", raydiumAuthority.toBase58());
      ...
      const migrateTx = await program.methods
        ...
        .remainingAccounts([
          { pubkey: cpSwapProgram, isWritable: false, isSigner: false },
          { pubkey: raydiumAuthority, isWritable: false, isSigner: false },
          { pubkey: raydiumPoolState, isWritable: true, isSigner: false },
          { pubkey: raydiumLpMint, isWritable: true, isSigner: false },
          { pubkey: token0Vault, isWritable: true, isSigner: false },
          { pubkey: token1Vault, isWritable: true, isSigner: false },
          { pubkey: createPoolFee, isWritable: true, isSigner: false },
